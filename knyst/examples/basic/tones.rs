...
/// 2. Outputs the oscillators to the left and right channels at 30% volume each.
...
fn main() -> Result<()> {
    ...
    graph_output(1, node1 * 0.3);

    println!("Playing sine waves at 110 and 220 Hz at an amplitude of 0.3");
